...
class _PageOneState extends State<Spot> {
  ...
  Future<void> predictSpot() async {
    final url = Uri.parse('https://feeshflaskdocker.onrender.com/predictSpot');

    final mappedData = {
      'time': timeMapping[dropdownValue1] ?? dropdownValue1,
      ...
      'hum': humidityMapping[dropdownValue4] ?? dropdownValue4,
      'windd': windDirectionMapping[dropdownValue5] ?? dropdownValue5,
      'winds': windsController.text,
      'level': tideLevelMapping[dropdownValue6] ?? dropdownValue6,
      'dir': tideDirectionMapping[dropdownValue7] ?? dropdownValue7,
    };
        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text("Predict Spot", style: Theme.of(context).textTheme.headlineLarge),
                SizedBox(height: 20),
